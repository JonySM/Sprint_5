...
class TestSellarRegistration:
    def test_success_registration(self, driver):
        ...
        WebDriverWait(driver, Settings.WAIT_TIME).until(EC.visibility_of_element_located(Locators.MAIN_LOGIN_TEXT))
    ...
    def test_registration_with_invalid_password(self, driver):
        ...
        WebDriverWait(driver, Settings.WAIT_TIME).until(EC.visibility_of_element_located(Locators.ERROR_TEXT))
