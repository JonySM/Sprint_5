...
class TestStellarLogin:
    def test_login_main_page(self, driver):
        ...
        l_k_button.click()
        WebDriverWait(driver, Data.WAIT_TIME).until(EC.visibility_of_element_located(Locators.OUR_NAME_TEXT))
    ...
    def test_login_from_lk_page(self, driver):
        ...
        l_k_button = driver.find_element(*Locators.L_K_BUTTON)
        l_k_button.click()
        WebDriverWait(driver, Data.WAIT_TIME).until(EC.visibility_of_element_located(Locators.OUR_LOGIN_TEXT))
